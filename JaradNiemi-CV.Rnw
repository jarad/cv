...
\item Other statistical community service (hyperlinked if appropriate)
 \begin{itemize}
 \item Cross-validated user \href{http://stats.stackexchange.com/users/40440/jaradniemi}{2,711 rep}
...
\item Departmental service
	...
	\item ISU Department of Statistics 
		\begin{itemize}
		\item Computation Advisory Committee, member (2011--2015,2016--present)

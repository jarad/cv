...
``Fully Bayesian analysis for hierarchical count regression models.'' University of California, Irvin, 28 Nov 2017
...
\item Refereeing
 \begin{itemize}
 \item Journal of the American Statistical Association (2017),

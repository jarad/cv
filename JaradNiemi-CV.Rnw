...
\item {\bf University service}
  ...
  \item ISU LAS CASTLE (2020--present)
...
\item {\bf Departmental service}
	...
	\item ISU Department of Statistics
		\begin{itemize}
		\item Graduate Student Services Specialist Search Committee, member (2022)
		...
		\item Graduate Recruiting and Admissions Committee, member (2020--current), chair (2022--current)

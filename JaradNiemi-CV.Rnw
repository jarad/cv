...
``Gaussian Process Emulators with FUnctional Inputs for Water Erosion Prediction Project'' NCCC-170, 15 Jun 2023

``Computer Model Emulation in Agriculture.'' NCCC-170, 16 Jun 2022
...
\item 2021 American Society of Agronomy \href{https://acsess.onlinelibrary.wiley.com/doi/full/10.1002/agj2.21069}{Presidential Award} (\href{https://nccc170.netlify.app/}{NCCC-170})
...
\item Other statistical community service (hyperlinked if appropriate)
 ...
 \item \href{https://nccc170.netlify.app/}{NCCC-170 Website} Development Lead (2022--present)

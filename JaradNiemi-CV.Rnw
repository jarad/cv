...
\item Other statistical community service (hyperlinked if appropriate)
 \begin{itemize}
 \item First Robotics Competition \href{https://www.teamneutrino.org/}{Team Neutrino Mentor} (2024--current)
 \item Iowa State Science \& Technology Fair Judge (2022--2023)
 \item First Lego League Coach (2022--2024)
...
\item {\bf Departmental service}
	...
	\item ISU Department of Statistics
		\begin{itemize}		
		\item Graduate Recruiting and Admissions Committee, member (2020--current), director (2022--current)

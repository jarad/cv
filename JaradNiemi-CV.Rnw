...
SIAM UQ20, March 2020 (canceled due to COVID-19)
...
\item {\bf Departmental service}
 	\begin{itemize}
	\item ISU Department of Statistics
		\begin{itemize}		
		\item Statistical Consulting Director (2025--current)
		\item Graduate Recruiting and Admissions Committee, member (2020--current), director (2022--2025)
		...
		\item Faculty Search Committee, member (2018--2019, 2021--2022), chair (2023--2024)

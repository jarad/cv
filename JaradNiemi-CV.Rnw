...
\subsection{\bf Invited Presentations at Major Conferences} \vspace{-0.2in}

``Parallelized Markov chain Monte Carlo algorithms utilizing GPUs with an application to RNAseq data analysis,'' 9th International Conference of the RCIM WG on Computational and Methodological Statistics, University of Seville, Spain, 9-11 December 2016
...
\subsection{\bf Invited Presentations at Major Institutions} \vspace{-0.2in}
